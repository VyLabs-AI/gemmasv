...
This realizes Paper A's central technical claim (theory doc §5.2): once the
active-set partition is fixed, the SVM solution is the solution of a small linear
system in the bordered KKT matrix M, and the backward pass (VJP) reuses M^{-1}
(= the C&P matrix R). No second solve, no unrolling through the optimizer.
