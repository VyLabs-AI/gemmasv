...
New cost bridge & record; timing repetition &
8 reused records in 4 source blocks; 6 arms each &
48/48 arms completed; 1 warmup and 3 timing repetitions per arm;
0/8 proxy record-level solve point-precheck rebuilds \\
Retained-answer reanalysis & target cluster; history &
32 clusters; 96 existing histories &
all 96 scorable in each of 3 conditions; two matcher endpoints;
no new generations \\
...
\input{longmemeval_chat_v3_decoded_followup}
